...
export async function fetcher<JSON = any>(): Promise<User[]> {
  const primaClient = await import("prisma/client").then((m) => m.default);

  return await primaClient.user.findMany({
    take: 5,
  });
